const sampleQuestions = [
  {
    questionText: "Who is the first president of India?",
    options: [
      { answer: 'Rajendra Prasad', isCorrect: true },
      { answer: 'Radhakrishnan', isCorrect: false },
      { answer: 'Zakir Husaain', isCorrect: false },
      { answer: 'Varahagiri Venkata Giri', isCorrect: false },
    ]
  },
  {
